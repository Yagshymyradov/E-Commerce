...
//
//     final modelsTop = modelsTopFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

ModelsTop modelsTopFromJson(String str) => ModelsTop.fromJson(json.decode(str));

String modelsTopToJson(ModelsTop data) => json.encode(data.toJson());
...
class ModelsTop {
  ...
  factory ModelsTop.fromJson(Map<String, dynamic> json) => ModelsTop(
    count: json["count"],
