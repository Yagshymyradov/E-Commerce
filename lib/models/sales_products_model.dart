...
//
//     final modelsSale = modelsSaleFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

ModelsSale modelsSaleFromJson(String str) => ModelsSale.fromJson(json.decode(str));

String modelsSaleToJson(ModelsSale data) => json.encode(data.toJson());

class ModelsSale {
  ModelsSale({
    required this.actionProducts,
  });

  ActionProducts actionProducts;

  factory ModelsSale.fromJson(Map<String, dynamic> json) => ModelsSale(
    actionProducts: ActionProducts.fromJson(json["action_products"]),
  );

  Map<String, dynamic> toJson() => {
    "action_products": actionProducts.toJson(),
  };
}
...
class ActionProducts {
  ...
  factory ActionProducts.fromJson(Map<String, dynamic> json) => ActionProducts(
    count: json["count"],
